...
export function CategoryCard({ category }: CategoryCardProps) {
  return (
    <Link
      ...
      className="group relative min-h-64 overflow-hidden rounded-lg bg-[#253326] p-6 text-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-[#435d2d]/18 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#8ea95c]"
    >
      <Image
        src={category.image}
        alt=""
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-b from-[#253326]/10 to-[#253326]/90" />
